...
export function WelcomeSection() {
	...
	const [text] = useState([
		...
		"build interactive UI/UX using React",
		"set up a CI/CD pipelines",
		"develop websites using Next.js",
		"review and merge pull requests",
		"add logging and monitoring to the application"
	]);
			...
			<section id="intro" className="section" ref={introRef}>
				<div className="grid grid-cols-1 md:grid-cols-[1fr_0.5fr] lg:grid-cols-[1fr_0.7fr] gap-4 items-center">
					<div className="py-5 md:py-10">
						...
						>
							<p>
								Hi, I&apos;m <mark>Noé Alcantar</mark> a <mark>passionate</mark> software developer.
							</p>
						</h1>
						...
						>
							Turning ideas into reality through code is my passion.
						</p>
					</div>
